...
Configure the batch descriptors carried by `cfg` for callers that mirror the
SHTns C layout. See the note above for what the Julia batch transforms actually
use.
